...
var STORAGE_KEY = 'fwinonsm_unresolvedCases';
var SESSION_STORAGE_KEY = 'fwinonsm_sessions';
var SESSION_HISTORY_KEY = 'fwinonsm_sessionHistory';
var DEFAULT_ICON = '?';
...
function handleImportSessionsFile(event) {
  var file = event.target.files && event.target.files[0];
  if (!file) return;
  var reader = new FileReader();
  reader.onload = function (e) {
...
function renderPreviousSessionOptions() {
...
function readPreviousSessionIds() {
  try {
...
function savePreviousSessionIds(ids) {
  try {
